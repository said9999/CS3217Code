...
#define LEFT_Y 0
#define LEFT_WIDTH 2
#define LEFT_HEIGHT 600

#define RIGHT_X 1400
#define RIGHT_Y 0
#define RIGHT_WIDTH 2
#define RIGHT_HEIGHT 600
...
#define LEVELONE @"Level-1"
#define LEVEL2 @"Level 2"
#define LEVELTWO @"Level-2"
#define LEVEL3 @"Level 3"
#define LEVELTHREE @"Level-3"

#define WOLFDIE_PNG @"wolfdie.png"
#define WOLFSUCK_PNG @"windsuck.png"
