...
- (GameWolf*)init{
    ...
    NSMutableArray* imgs_ = [self getImgsWithName:WOLFDIE_PNG Row:4 Col:4];
    ...
    NSMutableArray* suckImgs = [self getImgsWithName:WOLFSUCK_PNG Row:2 Col:4];
    self.suckAnimation = [[UIImageView alloc] init];
    self.suckAnimation.animationImages = suckImgs;
    self.suckAnimation.animationDuration = ANI_TIME;
